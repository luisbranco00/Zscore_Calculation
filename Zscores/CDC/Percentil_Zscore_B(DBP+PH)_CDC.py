...
for _, row in data.iterrows():
    ...
    ps_str = row[variable_names.index('min_dbp_B')]
    ...
    Zbp = ((ps-y)/sd)
    row['Zscore Diastolic Blood Pressure B'] = Zbp
    ...
    data_with_spp.append({'Zscore Diastolic Blood Pressure B': Zbp,
        'Percentile Diastolic Blood Pressure B': Zscore_Percentil,
...
data_with_spp_df.to_csv(r'C:\Users\luisb\Downloads\Zscore_DBP_B.csv', index=False, encoding='utf-8', sep=';')
