...
for _, row in data.iterrows():
    ...
    ps_str = row[variable_names.index('min_sbp_A')]
    ...
    Zbp = ((ps-y)/sd)
    row['Zscore Sistolic Blood Pressure A'] = Zbp
    ...
    data_with_spp.append({'Zscore Sistolic Blood Pressure A': Zbp,
        'Percentile Sistolic Blood Pressure A': Zscore_Percentil,
