...
data = pd.read_csv(r'Path_to_csv_file.csv', encoding='utf-8', delimiter=';')
...
for _, row in data.iterrows():
    ...
    if gender == 0:
        weight_file = pd.read_csv(r"\WHO\Weight\Weight_Table_Girls.csv", encoding='utf-8', delimiter=';')
    elif gender == 1:
        weight_file = pd.read_csv(r"WHO\Weight\Weight_Table_Boys.csv", encoding='utf-8', delimiter=';')
    matched_rows=[]
...
output_file = r'\data_with_zscoreF_weight_A.csv'
